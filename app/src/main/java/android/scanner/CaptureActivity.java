...
public final class CaptureActivity extends Activity implements
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case PARSE_BARCODE_SUC: 
					Toast.makeText(activityReference.get(),	"Analytic success, results for:" + msg.obj, Toast.LENGTH_SHORT).show();
					break;
				case PARSE_BARCODE_FAIL:
					Toast.makeText(activityReference.get(), "Parsing failure",Toast.LENGTH_SHORT).show();
					break;
		...
		if (resultCode == RESULT_OK) {
			...
			switch (requestCode) {
				case REQUEST_CODE:
					...
					progressDialog.setMessage("Scan...");
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		Toast.makeText(this,
				"Identification results:" + ResultParser.parseResult(rawResult).toString(),
